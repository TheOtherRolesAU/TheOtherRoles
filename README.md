...
|----------|-------------|-----------------|
| 2021.11.9.2s| v3.0.0| [Download](https://github.com/Eisbison/TheOtherRoles/releases/download/v3.0.0/TheOtherRoles.zip)
...
**Version 3.0.0**
- Update to Among Us version v2021.11.9.2s
