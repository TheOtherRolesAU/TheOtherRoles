...
namespace TheEpicRoles.Objects {
    class Garlic {
        ...
        public static Sprite getGarlicSprite() {
            ...
            garlicSprite = Helpers.loadSpriteFromResources("TheEpicRoles.Resources.Garlic.png", 300f);
            return garlicSprite;
        }
        ...
        public static Sprite getBackgroundSprite() {
            ...
            backgroundSprite = Helpers.loadSpriteFromResources("TheEpicRoles.Resources.GarlicBackground.png", 60f);
