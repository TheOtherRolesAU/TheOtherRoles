    ...
    public class CustomColors {
        ...
        public static void Load() {
            ...
            colors.Add(new CustomColor { longname = "Peach", shortname = "PEACH", 
                                        ...
                                        isLighterColor = true });
            colors.Add(new CustomColor { longname = "Neon Green", shortname = "NEON", 
        ...
        public static class CustomColorPatches {
            ...
            private static class PlayerTabEnablePatch {
                public static void Postfix(PlayerTab __instance) {
                    Il2CppArrayBase<ColorChip> il2CppArrayBase = __instance.ColorChips.ToArray();
                    ...
                    for (int i = 0; i < il2CppArrayBase.Length; i++) {
                        ColorChip chip = il2CppArrayBase[i];
