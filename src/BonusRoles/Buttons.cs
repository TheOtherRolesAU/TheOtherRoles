    ...
    static class HudManagerStartPatch
    {
        ...
        public static void Postfix(HudManager __instance)
        {
            ...
            engineerRepairButton = new CustomButton(
                ...
                false,
                "BonusRoles.Resources.RepairButton.png",
                100f,
                Vector3.zero,
                __instance
            );
            ...
            janitorCleanButton = new CustomButton(
                ...
                true,
                "BonusRoles.Resources.CleanButton.png",
                100f,
                Vector3.zero,
                __instance
            );
            ...
            timeMasterRewindTimeButton = new CustomButton(
                ...
                true,
                "BonusRoles.Resources.RewindButton.png",
                100f,
                Vector3.zero,
                __instance
            );
            ...
            medicShieldButton = new CustomButton(
                ...
                false,
                "BonusRoles.Resources.ShieldButton.png",
                100f,
                Vector3.zero,
                __instance
            );
            ...
            shifterShiftButton = new CustomButton(
                ...
                true,
                "BonusRoles.Resources.ShiftButton.png",
                100f,
                Vector3.zero,
                __instance
            );
            ...
            seerRevealButton = new CustomButton(
                ...
                false,
                "BonusRoles.Resources.SeerButton.png",
                100f,
                Vector3.zero,
                __instance
            );
            ...
            morphlingButton = new CustomButton(
                () => {
                    if (Morphling.sampledTarget != null) {
                        ...
                        morphlingButton.killButtonManager.renderer.sprite = Morphling.getMorphSprite();
                ...
                () => {
                    ...
                    morphlingButton.killButtonManager.renderer.sprite = Morphling.getSampleSprite();
                }
            );
            ...
            camouflagerButton = new CustomButton(
                ...
                () => { return PlayerControl.LocalPlayer.CanMove; },
                true,
                "BonusRoles.Resources.CamoButton.png",
                100f,
                new Vector3(0f, 1.3f, 0f),
                __instance,
                true,
