...
namespace TheOtherRoles {
    public class CustomOptionHolder {
        ...
        public static void Load() {
            ...
            tricksterSpawnRate = CustomOption.Create(250, cs(Trickster.color, "Trickster"), rates);
            ...
            tricksterPlaceBoxCooldown = CustomOption.Create(251, "Trickster Box Cooldown", 10f, 0f, 30f, 2.5f);
