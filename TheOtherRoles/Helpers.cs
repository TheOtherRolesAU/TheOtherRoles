...
namespace TheOtherRoles {
    ...
    public static class Helpers {
        ...
        public static bool hidePlayerName(PlayerControl source, PlayerControl target) {
            ...
            else if (source.Data.Role.IsImpostor && (target.Data.Role.IsImpostor || target == Spy.spy || target == Spy.sidekickedSpy)) return false; // Members of team Impostors see the names of Impostors/Spies
