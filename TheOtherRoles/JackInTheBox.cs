...
namespace TheOtherRoles{
    ...
    public class JackInTheBox {
        ...
        public JackInTheBox(Vector2 p) {
            ...
            Vector3 ventOffset = new Vector3(0f, 0.25f, 0f);
            Vector3 position = new Vector3(p.x, p.y, PlayerControl.LocalPlayer.transform.position.z + 1f); 
            position += (Vector3)PlayerControl.LocalPlayer.Collider.offset - ventOffset; // Add collider offset and vent offset, such that DoMove and WalkPlayerTo end up at a valid position
            // Create the marker
