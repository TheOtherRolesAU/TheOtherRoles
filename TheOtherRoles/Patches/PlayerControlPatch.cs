...
namespace TheOtherRoles.Patches {
    ...
    public static class MurderPlayerPatch {
        ...
        public static void Postfix (PlayerControl __instance, [HarmonyArgument(0)] PlayerControl target) {
            ...
            // Trapper Button Sync
            if (Trapper.trapper != null && PlayerControl.LocalPlayer == Trapper.trapper && __instance == Trapper.trapper && HudManagerStartPatch.trapperTrapButton != null)
                HudManagerStartPatch.trapperTrapButton.Timer = Trapper.trapper.killTimer;
