    ...
    public class CustomColors {
        ...
        public static void Load() {
            ...
            colors.Add(new CustomColor { longname = "Hot Pink", //27
                                        ...
                                        isLighterColor = true });
            colors.Add(new CustomColor { longname = "Petrol", //28
