    ...
    public static class ChatCommands {
        ...
        public static class SetBubbleName { 
            public static void Postfix(ChatBubble __instance, [HarmonyArgument(0)] string playerName) {
                ...
                if (PlayerControl.LocalPlayer != null && PlayerControl.LocalPlayer.Data.Role.IsImpostor && (Spy.spy != null && sourcePlayer.PlayerId == Spy.spy.PlayerId || Spy.sidekickedSpy != null && sourcePlayer.PlayerId == Spy.sidekickedSpy.PlayerId) && __instance != null) __instance.NameText.color = Palette.ImpostorRed;
            }
        }
